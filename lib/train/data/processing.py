...
class STARKProcessing(BaseProcessing):
    ...
    def __init__(self, search_area_factor, output_sz, center_jitter_factor, scale_jitter_factor,
        ...
        self.tokenfd_output_sz = settings.tokenfd_sz
    ...
    def __call__(self, data: TensorDict):
        ...
        """
        # print(f"--- [DEBUG] STARKProcessing: Attempting to process data. Annotations: {data['search_anno']}")
        ...
        for s in ['template', 'search']:
            ...
            if (crop_sz < 1).any():
                ...
                # print(f"--- [DEBUG] INVALID SAMPLE: Bounding box too small for '{s}'. crop_sz={crop_sz}. Aborting. ---")
                return data
            ...
            images_tensor_odtrack = torch.stack(data[s + '_images'], dim=0)

            data[s + '_images_tokenfd'] = F.interpolate(
                images_tensor_odtrack,
                size=(self.tokenfd_output_sz, self.tokenfd_output_sz),
                mode='bicubic',
                align_corners=False
            )
