...
from lib.train.actors import SymTrackActor
# for import modules
import importlib
...
def run(settings):
    ...
    # Create network
    if settings.script_name == "symtrack":
        net = build_symtrack(cfg)
    else:
    ...
    if settings.script_name == "symtrack":
        ...
        actor = SymTrackActor(net=net, objective=objective, loss_weight=loss_weight, settings=settings, cfg=cfg)
