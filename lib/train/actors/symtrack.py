...
class SymTrackActor(BaseActor):
    """ Actor for training SymTrack models """
    ...
    def forward_pass(self, data):
        ...
        template_list_tokenfd = []
        for i in range(self.settings.num_template):
            template_list_tokenfd.append(data['template_images_tokenfd'][i])

        search_list_tokenfd = []
        for i in range(self.settings.num_search):
            search_list_tokenfd.append(data['search_images_tokenfd'][i])
        ...
        out_dict = self.net(template=template_list,
                            search=search_list,
                            template_tokenfd=template_list_tokenfd, 
                            search_tokenfd=search_list_tokenfd,     
