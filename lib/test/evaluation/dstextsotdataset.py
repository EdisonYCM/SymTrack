...
class DSTextSOTDataset(BaseDataset):
    """
    DSText_SOT_Test dataset, created for single object tracking.
    Follows the design pattern of official GOT-10k test dataset loader.
    """
    def __init__(self):
        super().__init__()
        self.base_path = self.env_settings.dstext_sot_dir
    ...
    def _construct_sequence(self, sequence_name):
        ...
        # Note that the third argument 'object_class' is set to 'dstext_sot'.
        return Sequence(sequence_name, frames_list_full, 'dstext_sot', ground_truth_rect.reshape(-1, 4))
