...
if __name__ == "__main__":
    ...
    parser.add_argument('--tracker_name', type=str, default='symtrack', help='Name of tracking method.')
    parser.add_argument('--cfg_name', type=str, default='baseline_text_scalear', help='Name of config file.')
