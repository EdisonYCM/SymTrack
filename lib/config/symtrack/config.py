...
cfg.MODEL.TEXT_BACKBONE = edict()
cfg.MODEL.TEXT_BACKBONE.CHECKPOINT = "./my_internvit_clean"
cfg.MODEL.FUSION = edict()
cfg.MODEL.FUSION.EMBED_DIM = 256
...
cfg.TRAIN.FINETUNE_FROM = ""  # A path to a specific checkpoint for fine-tuning
...
# DATA.TOKENFD_SIZE
# cfg.DATA.TOKENFD = edict()
cfg.DATA.TOKENFD_SIZE = 448
...
cfg.TEST.USE_GATED_MS = False
cfg.TEST.SCALE_FACTORS = [0.95, 1.0, 1.05]
cfg.TEST.UNCERTAINTY_THRESHOLD = 0.98 # If peak score is below this, trigger multi-scale

cfg.TEST.USE_KALMAN = False
cfg.TEST.KALMAN_ALPHA = 0.5 # Weight for fusing Kalman prediction and visual prediction
